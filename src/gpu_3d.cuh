...
class gpu_3d : public gpu_sys
{
private:
	spin_t *s1_D,*s2_D; //spins divice
	int2 *J_x_D, *J_y_D, *J_z_D; //koplungs kostant divice
...
public:
	gpu_3d(int L_,double T_, double h_);
	void sweep() override;
	...
	void swap(gpu_3d *sys, std::unique_ptr<spin_t[]> mask);
